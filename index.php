        ...
        <nav class="navbar">
            <div class="navbar__container">
                ...
                <ul class="navbar__menu">
                    ...
                    <li class="navbar__item">
                        <a href="/logintoquery.php" class="navbar__links">Query</a>
                    </li>
        ...
        <div class="main">
            <div class="main__container">
                <div class="main__content">
                    ...
                    <p  class="animateLong">Contact us for expert consulting advice.</p><br>
        ...
        <div class="services">
            ...
            <div class="services__container">
                ...
                <div class="services__card">
                    ...
                    <button><a href="/logintoquery.php">Email Us</a></button>
                </div>
            </div>
        </div>
